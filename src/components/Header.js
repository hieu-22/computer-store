                    ...
                    <div className="row">
                        ...
                        <div className="col-6">
                            <p className='text-end text-white mb-0'>
                                Hotline: <a className="text-white" href="tel:+84 370000654">+84 370000654</a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row align-item-center">
                        ...
                        <div className="col-5 col-align-center">
                            <div className="input-group" >
                                <input className="form-control py-1 rounded-start-1 fs-6" type="text" placeholder="Search Product Here..." />
                                <span className="input-group-text rounded-end-1"><BsSearch /></span>
                            </div>
                        </div>
                        <div className="col-5 col-align-center">
                            <div className="header-upper__links d-flex align-item-center justify-content-between w-100 ps-5">
                                <div className=''>
                                    <Link to="" className='d-inline-flex '>
                                        ...
                                        <p className='linkLabel text-white'>Compare<br />product</p>
                                    </Link>
                                </div>
                                <div className=''>
                                    <Link to="" className='d-inline-flex '>
                                        <img src="images/wishlist.svg" alt="wishlist" />
                                        <p className='linkLabel text-white'>Wish<br />list</p>
                                    </Link>
                                </div>
                                <div className=''>
                                    <Link to="" className='d-inline-flex '>
                                        <img src="images/user.svg" alt="user" />
                                        <p className='linkLabel text-white'>Log In /<br />Sign Up</p>
                                    </Link>
                                </div>
                                <div className=''>
                                    <Link to="" className='d-inline-flex '>
                            ...
                            <div className="menu-bottom d-flex align-item-center">
                                <div className='categories'>
                                    <div className="btn-group">
                                        <button type="button" className="dropdown-list btn btn-secondary dropdown-toggle bg-transparent border-0" data-bs-toggle="dropdown" aria-expanded="false">
